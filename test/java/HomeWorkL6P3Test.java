...
public class HomeWorkL6P3Test {
    ...
    HomeWorkL6P3Test homeWorkL6P3Test;
    ...
    public char[] insert(String surname, int mark) throws Exception {
        ...
        ResultSet res = stmt.executeQuery("SELECT surname, mark  FROM Students WHERE surname = " + surname);
        while (res.next()) {
    ...
    public char[] select(String surname) throws Exception {
        StringBuilder sb = new StringBuilder();
    ...
    public char[] update(String surname, int mark) throws Exception {
        StringBuilder sb = new StringBuilder();
